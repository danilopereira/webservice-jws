 ...
 * 
 */
@WebServiceClient(name = "HelloWebService", targetNamespace = "http://ws.exemplo.fiap.com.br/", wsdlLocation = "http://localhost:8083/hello?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8083/hello?wsdl");
